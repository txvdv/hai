...
import DocumentsView from './DocumentsViewWithModel.vue';
import { MockProxy, mock } from 'vitest-mock-extended';
import { DocumentBrowserViewModel, DocumentService } from '@hai/ui-core';
...
describe('DocumentsView', () => {
  let documentBrowserViewModel: DocumentBrowserViewModel;
      ...
      global: {
        provide: {
          core: {
            ...
            getDocumentBrowserViewModel: () => documentBrowserViewModel,
          },
        },
        stubs: {
