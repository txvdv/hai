/**
 * @see https://github.com/google/lovefield/blob/master/dist/error_code.json
 */
let LfErrorCodes = {
  "0": "System error",
  ...
  "354":
    "Unable to open WebSQL database. {0}. See https://github.com/google/lovefield/blob/master/docs/FAQ.md for possible explanation.",
  ...
  "361":
    "Unable to open IndexedDB database: {0}, {1}. See https://github.com/google/lovefield/blob/master/docs/FAQ.md for possible explanation.",
  "362": "Error deserializing row from IndexedDB: {0}, {1}",
  "363": "Error reading IndexedDB objectStore: {0}, {1}",
  ...
  "543":
    "Foreign key {0}. A primary key column can't also be a foreign key child column",
